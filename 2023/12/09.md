# 2023 年 12 月 9 日 (土)
ロードマップ学習開始158日目です。
本日から[weekly-report](https://github.com/nil-ramuda/weekly-report)リポジトリで週報の作成(12/3~今日の分から)と[monthly-report](https://github.com/nil-ramuda/monthly-report)リポジトリで月報の作成(先月11月分から)を始めました。
